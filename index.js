...
function displayBanner() {
  try {
    ...
    const asciiArt = figlet.textSync("Yaz", {
    ...
    console.log("\n");
    console.log(chalk.cyan("> ") + chalk.gray("Fuck rose shes a dirty cheater."));
    console.log(chalk.cyan("> ") + chalk.gray("https://guns.lol/yazaki"));
    console.log(
      chalk.cyan("> ") +
        chalk.gray("Yas is too retarded for ts")
    );
    console.log(chalk.cyan("> ") + chalk.gray("Collecting E-Girls"));
    console.log("\n");
  } catch (error) {
    // Fallback to simple banner if figlet library fails
    console.log("\n");
    console.log(chalk.cyan("=".repeat(50)));
    console.log(chalk.cyan("                     YAZBOT"));
    console.log(chalk.cyan("=".repeat(50)));
    console.log("\n");
  }
}
 ...
 */
log("Starting the YazBot or wtv...", "info");
