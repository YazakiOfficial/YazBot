  ...
  async execute(client, message, args) {
    try {
      const supportMessage = [
        "> ## 🛠️ **YazBot Selfbot Support**",
        "> ",
        "> ### 📋 **GitHub Repository**",
        "> **Issues & Bug Reports:** https://github.com/YazakiOfficial/YazBot",
        "> Report bugs, request features, or contribute to the project",
        "> ",
        "> ### 💬 **Support Server**",
        "> **Discord Server:** https://discord.gg/FDG5V5AfFh",
        "> Join our community for help, updates, and discussions",
        "> ",
        "> ### 👨‍💻 **Developers**",
        "> **Main Developer:** `Yazaki`",
        "> **Co-Developer:** `Urmoit/ChosenTechies`",
        "> ",
